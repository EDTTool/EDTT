...
def send_multiple_small_sdu_cis(transport, transmitter, receiver, trace, cis_handle, params):
...
def peripheral_send_multiple_small_sdu_cis(transport, peripheral, central, trace, params):
    ...
    success = send_multiple_small_sdu_cis(transport, peripheral, central, trace, cis_handle, params) and success
...
def peripheral_receive_multiple_small_sdu_cis(transport, peripheral, central, trace, params):
    ...
    success = send_multiple_small_sdu_cis(transport, central, peripheral, trace, cis_handle, params) and success
...
__tests__ = {
    ...
    # "IAL/CIS/FRA/PER/BV-22-C": [ial_cis_fra_per_bv_22_c, "Simultaneous Sending and Receiving SDUs, CIS"], # Failed to create CIG
